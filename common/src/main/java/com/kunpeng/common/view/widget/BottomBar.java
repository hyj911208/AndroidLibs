 ...
 * 绘制底部导航栏
 * <p>
 * getBinding().bottomBar.setContainer(R.id.fl_container)
 * .setTitleBeforeAndAfterColor("#777777", "#009E34")
 * .addItem(AirFragment.class, "大气", R.drawable.bottom_air_normal, R.drawable.bottom_air_pressed)
 * .addItem(WaterFragment.class, "水", R.drawable.bottom_water_normal, R.drawable.bottom_water_pressed)
 * .addItem(MessageFragment.class, "最新动态", R.drawable.bottom_message_normal, R.drawable.bottom_message_pressed)
 * .addItem(MapFragment.class, "地图", R.drawable.bottom_map_normal, R.drawable.bottom_map_pressed)
 * .addItem(PollutionFragment.class, "污染源", R.drawable.bottom_pollution_normal, R.drawable.bottom_pollution_pressed)
 * .build();
 */
